        ...
        <CardContent className="pt-6">
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="border rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 mt-1">12 vessels with similar service conditions</p>
            </div>
            
            <div className="border rounded-lg p-4">
              <h4 className="font-medium">Heat Exchangers - Process Area 2</h4>
              <p className="text-sm text-gray-600 mt-1">8 exchangers in high-temperature service</p>
            </div>
            
            <div className="border rounded-lg p-4">
              <h4 className="font-medium">Critical Piping Systems</h4>
              <p className="text-sm text-gray-600 mt-1">24 piping circuits in corrosive service</p>
            </div>
          </div>
        </CardContent>
      </Card>
