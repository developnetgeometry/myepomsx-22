  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        />
        <Button variant="outline" onClick={() => navigate('/manage/asset-register')} className="flex items-center gap-2">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-base">Asset name would appear here</p>
            </div>
            <div>
              <h3 className="text-sm font-medium text-muted-foreground">Type</h3>
              <p className="text-base">Asset type would appear here</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-base">Asset location would appear here</p>
            </div>
          </div>
          ...
          <div className="pt-4">
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="text-gray-600">Detailed asset information would appear here...</p>
              </CardContent>
            </Card>
          </div>
        </CardContent>
