    ...
    <Router>
      <Layout>
        <Routes>
          ...
          {/* Manage Routes */}
          <Route path="/manage/asset" element={<AssetDetailPage />} />
          <Route path="/manage/asset/:id" element={<AssetDetailsPage />} />
          ...
          <Route path="/maintain/work-order" element={<WorkOrderListPage />} />
          <Route path="/maintain/work-order/:id" element={<WorkOrderDetailPage />} />
          ...
          <Route path="/monitor/rbi-assessment/pressureVessel/:id" element={<RBIAssessmentPVDetailPage />} />
